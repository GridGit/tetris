var Game = function(){
	...
	this.createDiv = function(data,element,divs){
		for(var i = 0; i < data.length; i++){
			var div = [];
	...
	this.init = function(doms,type,dir){
		...
		// 生成主屏div
		this.createDiv(this.gameData,this.gameElement,this.gameDivs);
		// 生成右边方块div
		this.createDiv(this.nextDiamond.diamondData,this.diamondElement,this.diamondDivs);
